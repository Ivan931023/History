...
pixel_Zernike = 750;
Z = zeros(1,15); Zernike_n = 4;
Z(3) = 0.02; Z(4) = 0.04; Z(5) = -0.05;
Z(6) = 0.07; Z(7) = -0.05; Z(8) = -0.05;
Z(9) = -0.04+0.05; Z(15) = -0.04;
...
f1 = figure; imagesc(image,intensity_range); axis image; colorbar; colormap turbo; title('CCD image')
f3 = figure; imagesc(data_zoomin_nor,[0 1]); axis image off; colormap turbo
f4 = figure; imagesc(data_zoomin_simulation,[0 1]); axis image off; colormap turbo
f6 = figure;
